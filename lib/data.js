  ...
  founders: [
    {
      ...
      bio: "Kamran is a visionary technologist and the driving force behind Future&more's AI-first strategy. With deep expertise in autonomous systems and software architecture, he leads the charge in creating technologies that redefine industry boundaries.",
      imageUrl: "https://placehold.co/400x400/22252A/E0E0E0?text=Kamran+A",
      social: { linkedin: "#", twitter: "#", github: "#" },
    },
    {
      name: "Mohammad Numaan",
      title: "CTO & Co-founder",
      bio: "Mohammed is a master architect of complex AI systems. His profound understanding of machine learning, full-stack development, and scalable infrastructure ensures that Future&more's products are not only innovative but also robust and enterprise-ready.",
      imageUrl: "https://placehold.co/400x400/2A2225/E0E0E0?text=Mohammed+N",
      social: { linkedin: "#", twitter: "#", github: "#" },
    },
    ,
    {
      name: "Qazi Muneeb Shabir",
      title: "COO & Co-founder",
      bio: "Qazi is a visionary data architect, masterfully bridging the gap between raw data and strategic insight. His profound understanding of robust ETL pipelining and user-centric wireframing ensures that the company's initiatives are not only built on a foundation of scalable data but are also guided by clear, actionable analytics.",
      imageUrl: "https://placehold.co/400x400/2A2225/E0E0E0?text=Qazi+M",
      social: { linkedin: "#", twitter: "#", github: "#" },
    },
    {
      name: "Moomin Baktoo",
